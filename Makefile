...
amsrenamer: renamer.o renamer_directory.o renamer_file.o renamer_parser.o
	gcc renamer.o renamer_directory.o renamer_file.o renamer_parser.o -o amsrenamer
clean:
	rm -f renamer.o renamer_directory.o renamer_file.o renamer_parser.o amsrenamer